...
void VGeneral::ImprimirMensaje(string msj) { cout << msj; }
...
// Lee y valida un valor numerico sin decimales (int, long) en un rango de
// valores
...
// Lee y valida un valor numerico con decimales (float, double) en un rango de
// valores
double VGeneral ::LeerValidarNroDecimal(string msj, double valorinicial,
                                        double valorfinal) {
  double dato;
  do {
...
// Lee y valida un valor numerico con decimales (float, double) con un valor
// inicial
double VGeneral ::LeerValidarNroDecimalValorInicial(string msj,
                                                    double valorinicial) {
  double dato;
  do {
    dato = LeerNroDecimal(msj);
...
// Lee y valida un valor numerico con decimales (float, double) con un valor
// final
double VGeneral ::LeerValidarNroDecimalValorFinal(string msj,
                                                  double valorfinal) {
  double dato;
  do {
    dato = LeerNroDecimal(msj);
...
void VGeneral ::ImprimirChar(string msj, char c) { cout << msj << c; }
// Escribe un mensaje e imprime un dato de tipo string
void VGeneral ::ImprimirString(string msj, string s) { cout << msj << s; }
// Escribe un mensaje e imprime un dato numerico (int,long)
void VGeneral ::ImprimirNro(string msj, long n) { cout << msj << n; }
...
//------------------------------------------------------------------------------
// ****************METODOS PARA IMPRIMIR A NIVEL DE PANTALLA DE MANERA
// JUSTIFICADA********************
//------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
// ****************METODOS PARA TRABAJAR CON ARCHIVOS TEXTO DE ENTRADA DE
// DATOS********************
//-------------------------------------------------------------------------------------------------
// Permite Leer el nombre f�sico del archivo
// Aporte de Tapias Jean Carlos
// http://www.cplusplus.com/reference/clibrary/cstdio/fgets/
/* Lee el nombre f�sico del archivo a nivel de teclado y si es necesario se
   puede incluir la ruta donde se localiza el archivo */
...
bool VGeneral ::AbrirArchivoEntrada(std::ifstream &archivo,
                                    char nomb_arch[120]) {
...
bool VGeneral ::FinArchivo(std::ifstream &archivo) { return archivo.eof(); }
// Cierra el archivo
void VGeneral ::CerrarArchivoEntrada(std::ifstream &archivo) {
  archivo.close();
}
//---------------------------------------------------------------------------------------
// ****************METODOS PARA TRABAJAR CON ARCHIVOS TEXTO DE
// SALIDA********************
//---------------------------------------------------------------------------------------
// Permite abrir un archivo de salida
bool VGeneral ::AbrirArchivoSalida(std::ofstream &archivo,
                                   char nomb_arch[128]) {
...
// Graba en el archivo una l�nea con un dato num�rico con decimales (float,
// double)
void VGeneral ::GrabarDatoNroDecimalArchivo(std::ofstream &archivo,
                                            double nro) {
  archivo << setiosflags(ios::fixed) << setprecision(2) << nro << endl;
}
// Cierra el archivo de salida
void VGeneral ::CerrarArchivoSalida(std::ofstream &archivo) { archivo.close(); }
